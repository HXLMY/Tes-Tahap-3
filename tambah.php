  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> <a href="./data.php">Menu</a></li>
          <li class="breadcrumb-item active"> <a href="./tambah.php">Input </a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section class="section">
  ...
  <div class="mb-2">
    ...
    <!-- <input type="text" name="pembuatan" id="pembuatan" class="form-control" required> -->
    <input type="date" id="pembuatan" name="pembuatan" class="form-control" required>
  </div>
  <div class="mb-2">
    <label for="selesai" style="font-weight: bold;">END DATE</label><br>
    <!-- <input type="text" name="selesai" id="selesai" class="form-control" required> -->
  ...
  <div class="mb-2">
   ...
   <input type="progress" name="progres" id="progres" class="form-control" required >
